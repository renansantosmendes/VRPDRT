...
//        filePath = "/home/rmendes/VRPDRT/";
        ...
        System.out.println("FAZENDO UM TESTE INICIAL AQUI");
        ...
        //codigo para gerar as soluções aleatorias
        for (int i = 0; i < 21; i++) {
            List<ProblemSolution> solutions_hv = new ArrayList<>();
            initializeRandomPopulation(nadirPoint, parameters, reducedDimension, solutions_hv, 60000, requests,
            ...
            PrintStream populationStream = new PrintStream(".\\PopulationHV\\population_" + i + ".csv");
            solutions_hv.forEach(u -> populationStream.print(u.getOriginalObjectivesNormalized() + "\n"));
            System.out.println("Random solutions file number " + i + " saved in folder!");
        }
